...
>   **IMPORTANT:** *نظراً لأن جميع النماذج تسمى معلومات بشكل افتراضي، يرجى التحقق من أن النموذج الذي تحدده من النوع***الرئيسي***وليس شيئاً آخر.*
...
## <a name="task-2-edit-your-app"></a>المهمة \#2: تحرير تطبيقك
...
2.  إنشاء جهة اتصال جديدة
    ...
    1.  ينبغي أن يفتح التطبيق في عرض **جهات الاتصال النشطة**. إذا لم يكن كذلك، فحدد الزيارات على اليسار. 
