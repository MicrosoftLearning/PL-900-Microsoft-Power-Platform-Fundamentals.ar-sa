...
### المهمة رقم 3: إنشاء خطوة لإرسال بريد إلكتروني إلى الزائر
...
1. قم بتمييز **النص {Report Total Amount}** . استبدله **بالحقل **"المبلغ** الإجمالي للتقرير" عند إضافة** خطوة الزيارة.

1. قم بتمييز **النص {Report Due Date}** . استبدله بالحقل **"تاريخ** استحقاق التقرير" **من الخطوة عند إضافة** زيارة.
