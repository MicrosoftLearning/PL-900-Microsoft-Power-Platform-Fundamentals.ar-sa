<div id="readme" class="Box-body readme blob js-code-block-container p-5 p-xl-6 gist-border-0" dir="rtl">
  ...
  <tbody>
  <tr>
  <td><div>لنشاط المعملي 6: كيفية إنشاء حل تلقائي</div></td>
  <td><div>لوحدة 4: بدء استخدام Power Automate</div></td>
  </tr>
  </tbody>
</table>
</div></td>
...
# الوحدة 4: بدء استخدام Power Automate
...
2.  انقر فوق **جديد** وحدد **الأتمتة**، و**التدفق السحابي** ثم **مؤتمت**. سيؤدي هذا إلى فتح محرر تدفق Power Automate في نافذة جديدة.

3. في **اختر مشغِّل التدفق**، ابحث عن **Microsoft Dataverse**.

4. حدد المشغل **عند إضافة صف أو تعديله أو حذفه**، ثم انقر فوق **إنشاء**.
   ...
   * في خطوة المشغل، انقر فوق علامة الحذف (**...**) وانقر فوق **إعادة تسمية**. أعد تسمية هذا المشغل **"عند إضافة زيارة"**. هذه ممارسة جيدة، لذا يمكنك أنت ومحررو التدفق الآخرون فهم الغرض من الخطوة دون الحاجة إلى الخوض في التفاصيل.
...
9. ابحث عن *البريد* وحدد موصل **Office 365 Outlook** وإجراء **إرسال رسالة بالبريد الإلكتروني (V2)**.
...
10.  حدد اسم التدفق **بلا عنوان** في الجزء العلوي وأعد تسميته إلى `Visit notification`

11. اضغط على **حفظ**

    اترك علامة تبويب التدفق مفتوحة من أجل المهمة التالية. ينبغي أن يبدو تدفقك كما يلي تقريبًا:

![الصورة](https://user-images.githubusercontent.com/78555251/118340724-ccb13300-b4d9-11eb-96c2-c7b005bb9ac0.png)
...
2. انقر فوق **جديد** وحدد **الأتمتة**، و**التدفق السحابي** ثم **مجدول**. سيؤدي هذا إلى فتح محرر تدفق Power Automate في نافذة جديدة.

3. عيِّن التدفق على التكرار كل **15** دقيقة.
...
10.  إرسال إعلام بالبريد الإلكتروني

     * انقر فوق **إضافة إجراء** داخل حلقة التكرار "تطبيق على الكل". إضافة إجراء **إرسال رسالة بالبريد الإلكتروني (V2)** من اتصال **Office 365 Outlook**.
...
13.  أدخل التالي في حقل **النص**. إن **الاسم** هو محتوى ديناميكي من خطوة **الحصول على مبنى**. قد يلزمك التمرير إلى أسفل القائمة.
