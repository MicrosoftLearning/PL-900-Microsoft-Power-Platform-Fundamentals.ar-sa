...
## المهمة 1: إنشاء نموذج لدعم تطبيقك الجديد المستند إلى النموذج
...
> [!NOTE]
> في بعض الأحيان ستتم مطالبتك بتسجيل الدخول أثناء العمل مع المصمم. حدد X لإلغاء الخروج من شاشة تسجيل الدخول.

## المهمة 2: تحرير التطبيق المستند إلى النموذج ليناسب احتياجاتك

الآن بعد إنشاء التطبيق، سنقوم بإجراء بعض التغييرات على طريقة تقديم التطبيق. نحن ما يجب أن يكون لدينا مجموعتين متميزتين؛ الأشخاص والأحداث. نريد أن يكون جدول جهات الاتصال في مجموعة الأشخاص، وجميع جداول الأحداث في مجموعة الأحداث.
...
## المهمة 3: قم بتحرير النماذج وطرق العرض المختلفة في التطبيق المستند إلى النموذج لتناسب احتياجاتك.
...
15. ضمن **التنقل** على اليسار، مرر مؤشر الماوس فوق **طريقة عرض** جهات الاتصال، وحدد الأيقونة **تحرير** .
16. حدد **+ View Column**.
17. ابحث عن العمود نوع** جهة الاتصال وأضفه **إلى النموذج.
18. حدد الزر **حفظ ونشر**.

بعد ذلك، سنقوم بإجراء التغييرات اللازمة على النماذج المتبقية.

19.  ضمن **التنقل**، حدد **طريقة عرض** الأحداث.

لاحظ أنه قد يكون **هناك عمود EventDetails1** . إذا كان الأمر كذلك، فسنزيله من طريقة العرض. *(إذا لم يكن لديك،* **يمكنك التخطي إلى الخطوة 28***)*

20.  مرر مؤشر الماوس فوق **طريقة عرض** الأحداث وحدد **الزر تحرير** .

إذا تمت مطالبتك بحفظ **** التغييرات، فحدد **حفظ ومتابعة**.

21.  في **طريقة العرض** حدد السهم الموجود بجانب **EventDetails1**، ومن القائمة التي تظهر، حدد **إزالة**.

![لقطة شاشة توضح كيفية إزالة عمود إضافي من طريقة عرض.](media/f0f1484a4f3a679abc18cdb1cd5c04da.png)

22.  حدد الزر **حفظ ونشر**.
23.  حدد زر السهم **** للخلف للعودة إلى مصمم التطبيق.
24.  ضمن **التنقل**، مرر مؤشر الماوس فوق **نموذج** الأحداث** **وحدد **تحرير**.

    إذا تمت مطالبتك بحفظ التغييرات، فحدد **حفظ ومتابعة**.

25.  حدد **حقل تفاصيل الحدث1** واضغط على **المفتاح Delete** على لوحة المفاتيح.
...
26.  **حدد الزر حفظ ونشر**.
27.  حدد زر السهم **** للخلف للعودة إلى مصمم التطبيق.

إذا لم يكن لديك الحقل EventDetail1 في النموذج، فتابع هنا.

28.  في **شريط** الأوامر للتطبيق، حدد **الزر حفظ ونشر** .
29.  **حدد الزر رجوع** للعودة إلى **مدخل صانع** Power Apps.
30.  حدد **الرجوع إلى الحلول** للعودة إلى شاشة Power Apps** الرئيسية**.

## المهمة 4: اختبار التطبيق الجديد
...
3.  مرر مؤشر الماوس فوق **تطبيق إدارة** أحداث الدورة التدريبية الذي أنشأته للتو وحدد أيقونة **تشغيل** .
...
25.  أكمل تسجيل الجلسة كما يلي:
    ...
    -   **جلسة العمل:** مارك جونز

![لقطة شاشة لنموذج تسجيل الجلسة المكتمل.  ](media/16cccd9ebb949ba0f364211f1ee55d4d.png)
